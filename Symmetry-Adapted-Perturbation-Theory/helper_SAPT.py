...
class helper_SAPT(object):
    ...
    def __init__(self, psi, energy, dimer, memory=2):
        ...
        self.Co_A = self.wfnA.Ca_subset("AO", "OCC")
        self.Cv_A = self.wfnA.Ca_subset("AO", "VIR")
        ...
        self.Co_B = self.wfnB.Ca_subset("AO", "OCC")
        self.Cv_B = self.wfnB.Ca_subset("AO", "VIR")
